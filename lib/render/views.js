 ...
 */
export function b50View({ theme = 'prism_plus', qqid = null, player, best50, serviceName, botName, fit = false, fitTotal = 0, variantLabel = null }) {
  const images = []
  const texts = []
  ...
  if (variantLabel) {
    texts.push(txt(truncateByWidth(variantLabel, 60), 700, 213, 22,
