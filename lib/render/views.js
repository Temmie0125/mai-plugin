 ...
 * @param {object} opts.best50 Best50（fit 模式下其 sd/dx 为拟合口径、totals 为拟合合计）
 ...
 */
export function b50View({ theme = 'prism_plus', qqid = null, player, best50, serviceName, botName, fit = false, fitTotal = 0 }) {
  const images = []
  const texts = []
