 ...
 *
 * 随心配变体（FC50/单刷50/寸50…，lib/variantB50.js + apps/score.js）与水鱼 AP50 已按上述约束落地：
 * 它们只经 getPlayerResultCached **读** records，既不调用 writeB50/writeRecords，也不经
 * getBest50WithCache（护栏⑤源码级断言）。新增变体时照此办理：加判定式即可，**勿碰任何写入口**。
 */
